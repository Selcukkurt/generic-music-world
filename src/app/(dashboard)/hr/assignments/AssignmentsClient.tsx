...
import { fetchOrgUnits, fetchPersonAssignments } from "@/lib/org-structure/data";
  ...
  if (loading) {
    return (
      <div className="flex w-full flex-col gap-6">
        <PageHeader title="Atamalar" subtitle="Organizasyon birimleri ve personel atamaları." />
