-- ============================================================
-- Production fix + Event Hub migration
-- Run this entire file in Supabase SQL Editor.
-- ============================================================
-- Fixes: audit_logs_category_check violation by normalizing
-- invalid categories to 'system' before altering the constraint.
-- Then applies the full event hub migration (idempotent).
-- ============================================================
