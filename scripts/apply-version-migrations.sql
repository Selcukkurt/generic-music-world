...
-- ============================================================
-- Migration 11: compliance onboarding (agreements + GM DNA section progress)
-- Requires: public.app_users, public.can_read_rbac_user_directory (see supabase migrations)
-- ============================================================
